...
<?php
    if(isset($_POST["submit_form"])){
        ...
        header("location: opportunite.php");
        exit;    
    }
...
<head>
    ...
    <title>Opportunités-PROXIMA</title>
</head>
<body>
    <header>
        <nav class="navbar">
    ...
    <main class="main">
        <div class="screen">
            <div class="article">
                <?php
                    $db = ConnectionDB();
                    $stmt = $db->query("SELECT * FROM ressources WHERE categories ='opportunités' ORDER BY id DESC LIMIT 1  ");
                ?>
